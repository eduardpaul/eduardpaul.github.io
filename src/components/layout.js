...
`)
  ...
  return (
    <div data-is-root-path={isRootPath} className="min-h-screen flex flex-col bg-gray-50 text-gray-800 antialiased">
      ...
      {isRootPath ? null : (
        <section className="bg-white shadow-sm rounded-xl mx-auto max-w-6xl my-6 px-6 py-5 flex flex-col md:flex-row md:items-center md:justify-between gap-5">
          <div className="flex flex-col sm:flex-row sm:items-center gap-4">
            ...
            <div className="text-center sm:text-left">
              <h1 className="text-xl font-bold text-gray-900">{profile.name} {profile.surnames}</h1>
